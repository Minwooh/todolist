const btn = document.getElementById("add-button"); //버튼
let addValue = document.getElementById("toDo"); //할일 입력
...
function addTodo() {
  if (addValue.value == false) {
    ...
    list.addEventListener("click", function () {
      ...
      // let clickedValue = list.innerHTML;
      // list2.innerHTML = clickedValue;
      // result2.appendChild(list2);
    });
  }
}
